...
arraydecl: IDV LSB NUMBERLIT? (CM NUMBERLIT)* RSB;
...
arrayconsdecl:IDC LSB NUMBERLIT? (CM NUMBERLIT)* RSB;
literals: NUMBERLIT|STRINGLIT|BOOLEANLIT|jsonlit|expr;
...
index_oper: (IDV|IDC) LSB RSB| (IDV|IDC) LSB NUMBERLIT (SM NUMBERLIT)*RSB;
...
infor: FOR IDV IN (arraylit|IDC|IDV) LCB body* RCB;
offor: FOR IDV OF (jsonlit|IDC|IDV) LCB body* RCB;
...
jsonmember: IDV COLON literals2;
...
key_operators: LSB expr RSB | LSB expr RSB key_operators;
